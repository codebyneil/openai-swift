...
struct SwiftDataStructuredOutputTests {
    ...
    struct ModelBuilderTests {
        ...
        func testDateDecodingStrategies() {
            ...
            let iso8601Result = StructuredOutputToSwiftData.convert(iso8601Input, using: iso8601Config)
            ...
            let secondsResult = StructuredOutputToSwiftData.convert(secondsInput, using: secondsConfig)
            ...
            let customResult = StructuredOutputToSwiftData.convert(customInput, using: customConfig)
