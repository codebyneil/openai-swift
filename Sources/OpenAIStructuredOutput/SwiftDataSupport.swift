...
extension StructuredOutputGenerator {
    ...
    public static func generateStructuredOutput<T>(forSwiftDataModel modelType: T.Type) -> [String: Any] {
    ...
    private static func isTransientProperty<T>(_ propertyName: String, in modelType: T.Type) -> Bool {
...
@available(iOS 17.0, macOS 14.0, tvOS 17.0, watchOS 10.0, *)
public extension SwiftDataStructuredOutput {
    static var structuredOutputDescription: String? { nil }
    static var includedProperties: [String]? { nil }
    static var excludedProperties: [String]? { nil }
}
...
public struct SwiftDataRelationshipHandler {
    ...
    public static func schemaForRelationship(_ relationship: Any, isToMany: Bool) -> [String: Any] {
        if isToMany {
...
extension OpenAI {
    ...
    public func createChatCompletion<T>(
        ...
        let schema = StructuredOutputGenerator.generateStructuredOutput(forSwiftDataModel: swiftDataModel)
