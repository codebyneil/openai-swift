import Foundation
    ...
    public class SwiftDataModelBuilder {
        ...
        public func createModel<T: PersistentModel>(
            ...
            fatalError(
                "SwiftData model creation requires proper BackingData initialization. Use manual property setting instead."
            )
        }
    ...
    public struct StructuredOutputToSwiftData {
        ...
        private static func decodeKey(
            _ key: String, using strategy: ConversionConfiguration.KeyDecodingStrategy
        ) -> String {
            switch strategy {
            case .useDefaultKeys:
                return key
        ...
        private static func decodeDate(
            _ string: String, using strategy: ConversionConfiguration.DateDecodingStrategy
        ) -> Date? {
            switch strategy {
            case .iso8601:
    ...
    extension String {
        fileprivate func convertFromSnakeCase() -> String {
